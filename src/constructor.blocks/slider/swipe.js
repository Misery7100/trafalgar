...
// var target = document.querySelector('ul.testimonials__slides');

// alert(target);

// swipe(document.querySelector('ul.testimonials__slides'), { maxTime: 1000, minTime: 100, maxDist: 400,  minDist: 60 });

// target.addEventListener('swipe', function() {
